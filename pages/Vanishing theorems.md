...
- The Bochner technique is essentially a "completing of squares". We know $\Delta_{\partial_E}$, as a Laplacian, is positive definite. If $u$ is a harmonic $(p,q)$-form, i.e. $\Delta_{\bar \partial_E}u=0$, we get $\langle [i\Theta_E,\Lambda]u,u\rangle \leq 0$.
- If $E$ satisfies a condition forcing $[i\Theta_E,\Lambda]$
- ## A computation
