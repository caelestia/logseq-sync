...
- $$\operatorname{Hom}_G(P_\bullet,k) \otimes_k \operatorname{Hom}_G(P_\bullet,k) \xrightarrow{\mu} \operatorname{Hom}_G(P_\bullet\otimes P_\bullet,k) \xrightarrow{\Delta^*} \operatorname{Hom}_G(P_\bullet,k)$$
-
