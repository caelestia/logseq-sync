...
- ### Homology
- Proposition. (Homology Whitehead's theorem) If $X,Y$ are path connected and simply connected, and $f:X\to Y$ induces an isomorphism of singular homology groups, then it induces
- Corollary. Under the