...
- ### Whitehead's theorem
- Proposition. Let $f:X\to Y$ be a weak homotopy equivalence of topological spaces, and $K$ be a CW complex. Given $g:K\to Y$ continuous, there exists $\overline{g}:K\to X$ lifting $g$ up to homotopy $\overline{g}\simeq fg$.
	- Proof.
