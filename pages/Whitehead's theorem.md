...
- Invoking HELP, we can lift $\overline{h}$ to a homotopy $h:\Delta^1\times\Delta^n\to Z$ from some $h(0)$ to $u$, while also extending $k$. Such $h(0)$ is our desired lift of $\sigma$.
-
- QED