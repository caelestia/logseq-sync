...
- ### Whitehead's theorem
- Proposition. Let $f:X\to Y$ be a weak homotopy equivalence of topological spaces, and $K$ be a CW complex. Given $\overline{g}:K\to Y$ continuous, there exists $g:K\to X$ such that $fg\simeq \overline{g}$.
	- Proof. We build $g$ inductively on the skeleta $K^{(n)}$. Suppose we have built $g_{n-1}:K^{(n-1)}\to X$ and a homotopy $h_{n-1}:fg_{n-1}\simeq\overline{g}|_{K^{(n)}}$. For each $n$-cell $\sigma$ with attaching map $b:|\partial\Delta^n|\to K^{(n-1)}$, the extension problem is equivalent to
	- <!-- https://q.uiver.app/#q= -->
	  <iframe class="quiver-embed" src="https://q.uiver.app/#q=&embed" width="200" height="200" style="border-radius: 8px; border: none;"></iframe>
	- (Abbreviated $\operatorname{Sing}$ to $\operatorname{S}$.) As $\operatorname{S}(X),\operatorname{S}(Y)$ are Kan complexes, we have a factorization of $\operatorname{S}(f)$ as
...
- Lemma. If $X,Y$ are path connected and simply connected, and $f:X\to Y$ induces isomorphism of singular homology groups, then it induces isomorphism of homotopy groups.
	- Proof. By the LES of the pair $(M_f,X)$, we get $H_n(M_f,X)=0$. By [the relative Hurewicz theorem]([[Hurewicz Theorem]]), we see by induction that $\pi_n(M_f,X)=0$ for all $n\geq0$. By the relative LES, $f$ induces an isomorphism $\pi_n(X)\to \pi_n(M_f)\simeq\pi_n(Y)$. QED
