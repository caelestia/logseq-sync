...
- Lemma. If $H$ is locally compact dense subset of a Hausdorff space $X$, then $H$ is open.
	- Proof. Fix $x\in H$. Take an open neighborhood $U\subset X$, such that the closure $K$ of $U\cap H$ in $H$ is compact. Then $U\setminus K$ is open but doesn't intersect $H$, so $U\subset K\subset H$. Thus $H$ is open
-