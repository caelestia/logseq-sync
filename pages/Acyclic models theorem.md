...
- To apply the uniqueness of the theorem, it remains to check that $T_\bullet$ is acyclic on $\mathcal{M}$. Indeed, we can prove that the reduced homology of any convex subset $X$ of an Euclidean space is $0$. Fix a point $p\in X$, we