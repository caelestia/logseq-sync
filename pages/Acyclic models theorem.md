...
- Theorem. There is a natural isomorphism $\Psi:H_\bullet(X)\to H_\bullet(|X|)$.
	...
	-
- Remark. This proof does not actually rely on the acyclic models theorem, because there is an obvious construction of $\psi$; it is also given by the unit of the adjunction $\left|-\right|\dashv\operatorname{Sing}$.