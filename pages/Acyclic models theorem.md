...
- Remark. $K$ shows that the composition $N(P)\to N(\{\bot\})\to N(P)$ is homotopic to $\mathrm{id}$ on homology. It follows that $C(\Z N(P))$ is homotopy equivalent to the homology of a point.