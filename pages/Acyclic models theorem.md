...
- To apply the uniqueness of the theorem, it remains to check that $T_\bullet$ is acyclic on $\mathcal{M}$.
- By simply translating the argument to singular homology, we can prove that the reduced homology of any convex subset $X$ of an Euclidean space is $0$. Here the "apex"