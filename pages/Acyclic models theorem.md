...
- Theorem. There is a natural isomorphism $\Psi:H_\bullet(X)\to H_\bullet(|X|)$.
	...
	-
- Remark. This proof does not actually rely on the acyclic models theorem, because $\psi$ can be naturally constructed from the unit of the adjunction $\left|-\right|\dashv\operatorname{Sing}$.