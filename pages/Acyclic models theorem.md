...
- The barycentric subdivision is an explicitly defined natural chain map $\operatorname{Sd}_\bullet:S_\bullet\to S_\bullet$. Since $S_\bullet$ is free and acyclic on the models  $\{\Delta^p\}_p$, and $H_0\circ\operatorname{Sd}=
- $
-