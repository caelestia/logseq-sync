...
- To apply the uniqueness of the theorem, it remains to check that $T_\bullet$ is acyclic on $\mathcal{M}$. Since $\Delta^p\times I$ is homeomorphic to $\Delta^{p+1}$, this is the same as checking $S_\bullet$ is acyclic on the $\Delta^p$.
