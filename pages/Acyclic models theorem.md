...
- Remark. $K$ shows that the composition $N(P)\to N(\{\bot\})\to N(P)$ is homotopic to $\mathrm{id}$ at chain level. It follows that the chain complex associated to $N(P)$ is homotopy equivalent to that of a point.
-