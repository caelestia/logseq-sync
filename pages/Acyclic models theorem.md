...
- Proof. $\iota_0$ is a natural transformation, and so is $(\iota_0)_*=S_\bullet\circ\iota_0:S_\bullet\to T_\bullet$, where $T_\bullet(-):=S_\bullet(-\times I)$. The category $\mathscr{C}=\mathsf{Top}$, and we choose $\mathcal{M}=\{|}$