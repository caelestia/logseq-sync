...
- It follows formally that $\mathcal{O}\text{--}\mathsf{Mod}$ has enough injectives (Tohoku paper). This is due to Baer's critetion: $\mathcal{I}$ is injective iff $I\to0$ has right lifting against subobjects of $G$,