...
- Another way to construct injectives is this. If $\mathcal{F}$ is any $\mathcal{O}$-module, there is a canonical flasque resolution (induction), given by $\mathcal{F}_{\text{God}}:U\mapsto\bigoplus_{x\in U}\mathcal{F}_x$. We can further embed this in $U\mapsto\bigoplus_{x\in U}I_x$