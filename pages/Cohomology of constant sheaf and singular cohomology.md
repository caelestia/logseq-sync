...
- $$\operatorname{Sd}^\infty\sigma-\sigma=(\operatorname{Sd}-\operatorname{id})\sum_{i=0}^{N(\sigma)-1}\operatorname{Sd}^i\sigma=(\partial k+k\partial)\sigma-h\sum_{N(\partial\sigma)}$$
-