...
- ### Remark on the local
- It follows from local class field theory that, over a finite extension of $, any rank $4$ non-degenerate quadratic form represents $K^\times$, and so any rank $5$ non-degenerate quadratic form is universal.
-