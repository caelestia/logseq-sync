...
- Theorem. Let $(a_i)_{i\in I}$ be rational numbers indexed by a finite set $I$, and $\varepsilon_{i,v}\in\{\pm 1\}$ for all places $v$. Suppose all but finitely $\varepsilon_{i,v}$ are $1$, and product formula $\prod_{v}\varepsilon_{i,v}=1$ holds for all $i$. If