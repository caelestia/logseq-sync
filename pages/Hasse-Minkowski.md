...
- It follows from local class field theory that, over a finite extension of $\mathbb Q_p$, any rank $4$ non-degenerate quadratic form represents $K^\times$, and so any rank $5$ non-degenerate quadratic form is universal.
	- Combine the following facts:
	- non-degenerate + represents 0