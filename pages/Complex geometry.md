...
- Let $M$ be a real/complex manifold. The real tangent space $T_x(M)$ at $x$ is the set of equivalence class of curves $(-\varepsilon,\varepsilon)\to M$, $\varepsilon>0$, and $\gamma\sim\delta$ iff $\exists \