...
- Given a Hermitian vector bundle $E$ on a real manifold $X$, we have a bilinear pairing $\Omega^p_{X,\mathbb{C}}\otimes E\otimes\overline{\Otimes^q_{X,\mathbb{C}}\otimes E}