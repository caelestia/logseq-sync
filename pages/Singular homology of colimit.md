...
- ### Singular homology
	- Lemma. Let $Y_0\hookrightarrow Y_1\hookrightarrow\cdots\hookrightarrow Y_\alpha\hookrightarrow\cdots$ (indexed by ordinals $\alpha$ less than some $\$) be closed embeddings of T1 spaces, $Y=\varinjlim Y_n$. If $A$ is compact, then any map $A\to Y$ factors through some $Y_n$.
