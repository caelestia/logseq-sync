...
- ### Singular homology
	...
	- Since geometric realization commutes with all colimits, and homology commutes with filtered colimits, we reduce the comparison to finite simplicial sets.
	-