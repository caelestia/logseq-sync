...
- ### Singular homology
	...
	- Corollary. If $A$ is a compact subset of a CW complex, then it only intersects finitely many open cells. Moreover, it's contained in a finite subcomplex.
		- Proof. In the above, let each $Y_{\alpha+1}\setminus Y_\alpha$ be an open cell. Then $B$ can only intersect finitely many of them. It is clear by induction that
