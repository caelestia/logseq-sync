...
- ### Singular homology
	...
	- By (1) again, the pushout $Y'=Y\cup D^n$ induces a short exact sequence $0\to S_\bullet(S^{n-1})\to S_\bullet(Y)\oplus S_\bullet(D^n)\to S_\bullet(Y')\to 0$, which splits by virtue of freeness.
