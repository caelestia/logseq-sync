...
- Thm. We have $[\partial,L]=0$ and $[\partial^*,L]=-i\bar\partial$.
	...
	- $\partial_k$ commutes with $L=i\sum_j \varepsilon_j\varepsilon_{\bar j}$.
...
- ### Hermitian vector bundle case
- Let $(E,h)$ be a Hermitian holomorphic vector bundle, and let $D=D'+D''$ be its Chern connection. Thus $D''=\bar\partial_E$. The operators $L$ and $\Lambda$ act only on the form part of an $E$-valued form.
