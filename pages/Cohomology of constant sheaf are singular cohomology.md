...
- We want to show that $S^\bullet\to S^{\mathcal{U}\bullet}$ is a homotopy equivalence. Since this is "absolute" it suffices to show it for $S_{\mathcal{U}\bullet}\to S_\bullet$.
-