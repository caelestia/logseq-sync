...
- We claim that these $\sigma^x$ agree on pairwise intersections. If $z\in M_x\cap M_y$, take $i$ such that $z\in V_i$. Then $i\in I_x\cap I_y$ by definition, thus $M_x\cup M_y\