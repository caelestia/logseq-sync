...
- ### Proof of Lemma 2
- Let $\mathcal{U}$ be an open cover of $X$, define the complex of presheaves $S^{\mathcal{U}\bullet}$ of cochains that assigns a value for each simplix $\Delta^i\to U\in\mathcal{U}$.
-