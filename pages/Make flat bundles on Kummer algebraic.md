...
- ### Step 4 Lemmas
- Lemma. Let $X$ be a non-singular variety and $\widetilde X$ be the blow-up centered at a non-singular closed subvariety $Y$, with exceptional divisor $F$. Then passing to some affine chart $U\simeq\operatorname{Spec}A$ of $X$, we have $F\simeq\mathbb{P}^{\text{codim}(Y,X)-1}_A$. Thus
- $$H^i(F,\mathcal{O}_F)=\begin{cases}\,&i=0,\\0,&i>0.\end{cases}$$
