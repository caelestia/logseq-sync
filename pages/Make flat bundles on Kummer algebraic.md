...
- ### Step 4 Lemmas
- Let $Y\subset X$ be varieties and $\widetilde X$ be the blow-up centered at $Y$.
- Lemma. If $Y$ is regular, then on an affine chart $\operatorname{Spec}A$ of $X$, we have $F\simeq\mathbb{P}^{\text{codim}(Y,X)-1}_A$, and so
