...
- ## Group structure
- For $\mathcal{F},\mathcal{G}$ minimal Cauchy filters, define $\mathcal{F}+\mathcal{G}$ as the Cauchy filter generated by the base $\{F+G:F\in\mathcal{F},G\in\mathcal{G}\}$. Then $\hat G$ is an abelian group with identity element $\mathcal{N}_0=\{U\ni0\}$, and the inverse of $\mathcal{F}$ is given by the Cauchy filter generated by