...
- **Lemma.** The map $\iota$ is continuous with dense image.
	...
	- Now, to prove density, we show that there exists $\mathcal{N}_g\in\mathcal{F}+\tilde U$ for all $\mathcal{F}$ and $U$. Let $A+W\in\mathcal{F}$ such that $A+W-(A+W)\subset U$,