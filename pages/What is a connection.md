...
- A section $\nabla$ of $\sigma$ is a connection of the trivial line bundle.
	- In local coordinates, $\mathcal{D}^1\simeq\mathcal{A}\oplus\mathcal{T}$ canonically. This is because we can exponentiate (i.e. parallel transport) a tangent vector into a vector field locally