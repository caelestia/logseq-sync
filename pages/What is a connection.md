...
- A connection is equivalently a splitting of the tangent bundle of the total space $E$:
  $$T_E = V \oplus H$$
- Let $e\in E$, $x:=\pi(e)$, where $\pi:E\to M$ is the projection. The *vertical space* $V_e:=\ker(d\pi)_e$ at $e$. Clearly, this is canonically isomorphic to the vector space $\pi^{-1}(x)=E_x$. We have the SES
