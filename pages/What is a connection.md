...
- Thus there are two ways to obtain the splitting:
	...
	- We can also find a projection $T_{E,e}\to V_e$. Let $v$ be a vector in $T_{E,e}$ and choose a curve $\gamma:(-\epsilon,\epsilon)\to E$ such that $\gamma(0)=e$ and $\gamma'(0)=v$. Then the covariant derivative $\nabla_{\pi(v)}
