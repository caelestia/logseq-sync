...
- Take some large $m$ s.t. $mh$ is very ample on $Y$. Let $j:X \hookrightarrow \mathbb P^N$ s.t. $mH$ is the pullback of the hyperplane divisor. Since $X$ is a projective variety, hence proper, $j$ is a closed embedding.
- By Bertini's theorem (Hartshorne II.8.18 and the remark after), there is a hyperplane in $\mathbb P^N$ whose intersection with $j(X)$ is non-singular.
