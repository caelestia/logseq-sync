...
- $$d_\mathcal{E} = \frac{1}{4}\sum -2(m_{i,1}+m_{i,2})^2 + 2\sum m_{i,1}m_{i,2} = -\frac{1}{2}\sum (m_{i,1}-m_{i,2})^2 \leq 0.$$
...
- We have by assumption $\mathcal{M}|_C\hookrightarrow\mathcal{E}|_C$ because $C$ is Cartier. Since [[flat bundles are semistable]], $\mu(\mathcal{E}|_C)=0$ and $\mu(\mathcal M|_C)\leq\mu(\mathcal{E}|_C)$. By definition, $\mu(\mathcal M|_C)=c_1(\mathcal{M}|_C)$ since $h|_C$ is an ample divisor.
