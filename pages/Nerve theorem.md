...
- For each $q\geq0$, we have the Cech complex of the singular $q$-chains functor. Observe that this complex is acyclic. Indeed, let $\sigma$ be a singular $q$-simplex.