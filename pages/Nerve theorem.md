...
- ### Conclusion
- We've shown that the homology groups $H_n(X)$ and $H_n(|N_\mathcal{U}|)$ are isomorphic.
- However, this does not give us an explicit map $X\to |N_\mathcal{U}|$ inducing the isomorphism, and we cannot apply Whitehead's theorem.